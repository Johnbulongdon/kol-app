...
const TRANSLATIONS = {
  ...
  food:           { ja:"料理", ko:"음식", zh:"美食", ar:"طبخ", hi:"खाना", th:"อาหา�?, ru:"еда", tr:"yemek", id:"makanan" },
  cooking:        { ja:"料理レシ�?, ko:"요리", zh:"烹饪", ar:"وصفات طبخ", hi:"खाना बनान�?, th:"ทำอาหา�?, ru:"кулинария", tr:"yemek tarifi", id:"memasak" },
  tech:           { ja:"テクノロジー", ko:"기술", zh:"科技", ar:"تقنية", hi:"तकनी�?, th:"เทคโนโลยี", ru:"технологии", tr:"teknoloji", id:"teknologi" },
  gaming:         { ja:"ゲーム実�?, ko:"게임", zh:"游戏", ar:"العاب", hi:"गेमिंग", th:"เกม", ru:"игры", tr:"oyun", id:"gaming" },
  beauty:         { ja:"美容", ko:"뷰티", zh:"美妆教程", ar:"مكياج", hi:"सौंदर्�?, th:"ความงา�?, ru:"красота", tr:"güzellik", id:"kecantikan" },
  fashion:        { ja:"ファッション", ko:"패션", zh:"时尚穿搭", ar:"موضة", hi:"फैशन", th:"แฟชั่น", ru:"мода", tr:"moda", id:"fashion" },
  travel:         { ja:"旅行vlog", ko:"여행", zh:"旅行", ar:"سفر", hi:"यात्रा", th:"ท่องเที่ย�?, ru:"путешествия", tr:"seyahat", id:"traveling" },
  music:          { ja:"音楽", ko:"음악", zh:"音乐", ar:"موسيقى", hi:"संगी�?, th:"ดนตร�?, ru:"музыка", tr:"müzik", id:"musik" },
  education:      { ja:"教育", ko:"교육", zh:"教育学习", ar:"تعليم", hi:"शिक्षा", th:"การศึกษา", ru:"образование", tr:"eğitim", id:"edukasi" },
  lifestyle:      { ja:"ライフスタイ�?, ko:"일상", zh:"生活vlog", ar:"روتين يومي", hi:"जीवन शैली", th:"ไลฟ์สไตล�?, ru:"образ жизни", tr:"yaşam tarzı", id:"lifestyle" },
  sports:         { ja:"スポーツ", ko:"스포�?, zh:"体育运动", ar:"رياضة", hi:"खे�?, th:"กีฬา", ru:"спорт", tr:"spor", id:"olahraga" },
  makeup:         { ja:"メイクアップ", ko:"메이크업", zh:"化妆教程", ar:"مكياج تعليمي", hi:"मेकअ�?टिप्�?, th:"สอนแต่งหน้�?, ru:"макияж", tr:"makyaj", id:"makeup" },
  skincare:       { ja:"スキンケ�?, ko:"스킨케�?, zh:"护肤�?, ar:"العناية بالبشرة", hi:"स्कि�?केयर", th:"สกินแคร์", ru:"уход за кожей", tr:"cilt bakımı", id:"skincare" },
  vlog:           { ja:"日常vlog", ko:"일상브이로그", zh:"日常vlog", ar:"يوميات", hi:"व्लॉ�?, th:"วีล็อก", ru:"влог", tr:"günlük vlog", id:"vlog harian" },
  comedy:         { ja:"お笑�?, ko:"개그", zh:"搞笑视频", ar:"فيديو مضحك", hi:"कॉमेडी", th:"ตล�?, ru:"юмор", tr:"komedi", id:"komedi" },
  yoga:           { ja:"ヨガ", ko:"요가", zh:"瑜伽", ar:"يوغا", hi:"यो�?, th:"โยคะ", ru:"йога", tr:"yoga", id:"yoga" },
  review:         { ja:"レビュー", ko:"리뷰", zh:"测评", ar:"مراجعة منتجات", hi:"रिव्यू", th:"รีวิ�?, ru:"обзор", tr:"inceleme", id:"review" },
  health:         { ja:"健康", ko:"건강", zh:"健康养生", ar:"صحة", hi:"स्वास्थ्�?, th:"สุขภาพ", ru:"здоровье", tr:"sağlık", id:"kesehatan" },
  diet:           { ja:"ダイエット", ko:"다이어트", zh:"减肥瘦身", ar:"حمية", hi:"डाइट", th:"ลดน้ำหนั�?, ru:"диета", tr:"diyet", id:"diet" },
  workout:        { ja:"筋ト�?, ko:"운동", zh:"健身训练", ar:"تمرين", hi:"वर्कआउ�?, th:"ออกกำลังกา�?, ru:"тренировка", tr:"egzersiz", id:"olahraga" },
  news:           { ja:"ニュース", ko:"뉴스", zh:"新闻", ar:"أخبار", hi:"समाचार", th:"ข่าว", ru:"новости", tr:"haberler", id:"berita" },
  business:       { ja:"ビジネス", ko:"비즈니스", zh:"商业", ar:"أعمال", hi:"व्यापा�?, th:"ธุรกิจ", ru:"бизнес", tr:"iş", id:"bisnis" },
  car:            { ja:"�?, ko:"자동�?, zh:"汽车", ar:"سيارات", hi:"का�?, th:"รถยนต์", ru:"автомобиль", tr:"araba", id:"mobil" },
  anime:          { ja:"アニ�?, ko:"애니메이�?, zh:"动漫", ar:"انمي", hi:"एनीमे", th:"อนิเมะ", ru:"аниме", tr:"anime", id:"anime" },
  pets:           { ja:"ペッ�?, ko:"반려동물", zh:"宠物", ar:"حيوانات أليفة", hi:"पालत�?जानव�?, th:"สัตว์เลี้ย�?, ru:"домашние животные", tr:"evcil hayvan", id:"hewan peliharaan" },
  // Crypto / Finance
  ...
  bitcoin:        { ja:"ビットコイン", ko:"비트코인", zh:"比特�?, ar:"بيتكوين", hi:"बिटकॉइ�?, th:"บิตคอยน์", ru:"биткоин", tr:"bitcoin", id:"bitcoin" },
  ethereum:       { ja:"イーサリアム", ko:"이더리움", zh:"以太�?, ar:"إيثريوم", hi:"एथेरिय�?, th:"อีเธอเรียม", ru:"эфириум", tr:"ethereum", id:"ethereum" },
  nft:            { ja:"NFT", ko:"NFT", zh:"NFT数字藏品", ar:"رمز غير قابل للاستبدال", hi:"एनएफटी", th:"NFT", ru:"НФТ", tr:"NFT", id:"NFT" },
  defi:           { ja:"DeFi分散型金�?, ko:"디파�?, zh:"去中心化金融DeFi", ar:"تمويل لامركزي", hi:"डीफा�?, th:"DeFi", ru:"децентрализованные финансы", tr:"DeFi", id:"DeFi" },
  blockchain:     { ja:"ブロックチェーン", ko:"블록체인", zh:"区块�?, ar:"بلوكشين", hi:"ब्लॉकचेन", th:"บล็อกเชน", ru:"блокчейн", tr:"blokzinciri", id:"blockchain" },
  trading:        { ja:"トレード", ko:"트레이딩", zh:"交易", ar:"تداول", hi:"ट्रेडिंग", th:"เทร�?, ru:"трейдинг", tr:"trading", id:"trading" },
  investment:     { ja:"投資", ko:"투자", zh:"投资理财", ar:"استثمار", hi:"निवे�?, th:"การลงทุน", ru:"инвестиции", tr:"yatırım", id:"investasi" },
  finance:        { ja:"投資", ko:"재테�?, zh:"理财", ar:"استثمار", hi:"निवे�?, th:"การเงิ�?, ru:"финансы", tr:"yatırım", id:"investasi" },
  stock:          { ja:"株式投資", ko:"주식", zh:"股票", ar:"أسهم", hi:"शेयर बाजा�?, th:"หุ้น", ru:"акции", tr:"borsa", id:"saham" },
  wallet:         { ja:"暗号資産ウォレッ�?, ko:"암호화폐 지�?, zh:"加密钱包", ar:"محفظة رقمية", hi:"क्रिप्टो वॉले�?, th:"กระเป๋าคริปโ�?, ru:"крипто кошелёк", tr:"kripto cüzdan", id:"dompet kripto" },
  card:           { ja:"カー�?, ko:"카드", zh:"�?, ar:"بطاقة", hi:"कार्�?, th:"บัตร", ru:"карта", tr:"kart", id:"kartu" },
  // Common multi-word phrases
  "crypto card":  { ja:"仮想通貨カー�?, ko:"암호화폐 카드", zh:"加密货币�?, ar:"بطاقة عملات مشفرة", hi:"क्रिप्टो कार्�?, th:"บัตรคริปโต", ru:"крипто карта", tr:"kripto kart", id:"kartu kripto" },
  "debit card":   { ja:"デビットカー�?, ko:"직불카드", zh:"借记�?, ar:"بطاقة خصم", hi:"डेबि�?कार्�?, th:"บัตรเดบิต", ru:"дебетовая карта", tr:"banka kartı", id:"kartu debit" },
  "credit card":  { ja:"クレジットカード", ko:"신용카드", zh:"信用�?, ar:"بطاقة ائتمان", hi:"क्रेडि�?कार्�?, th:"บัตรเครดิ�?, ru:"кредитная карта", tr:"kredi kartı", id:"kartu kredit" },
  "stock market": { ja:"株式市場", ko:"주식시장", zh:"股票市场", ar:"سوق الأسهم", hi:"शेयर बाजा�?, th:"ตลาดหุ้น", ru:"фондовый рынок", tr:"borsa", id:"pasar saham" },
  "passive income":{ ja:"不労所�?, ko:"수동 소득", zh:"被动收入", ar:"دخل سلبي", hi:"निष्क्रि�?आय", th:"รายได้เสริม", ru:"пассивный доход", tr:"pasif gelir", id:"penghasilan pasif" },
};
